...
const runtimeEnv = typeof process !== "undefined" ? process.env.NODE_ENV : undefined;
const debugFlag =
  typeof process !== "undefined"
    ? process.env.JDM_DEBUG_DATA ?? process.env.FERUZ_DEBUG_DATA
    : undefined;

export const isDebugEnabled =
  debugFlag === "true" || (debugFlag !== "false" && runtimeEnv !== "production");

export function summarizeDebugValue(value, depth = 0, key = "") {
