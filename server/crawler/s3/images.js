...
function buildPublicUrl(key, { bucket = process.env.S3_BUCKET, region = process.env.S3_REGION } = {}) {
...
function buildImageKey({ source, sourceListingId, index, url }, { prefix = process.env.S3_IMAGE_PREFIX || DEFAULT_IMAGE_PREFIX } = {}) {
...
async function mirrorListingPhotos(canonical, { uploadPhoto = uploadListingPhoto } = {}) {
